...
def interp_CW(
    ...
    CwL = Cw_tab[T_idx, Fn_idx] + Fn_frac * (
        Cw_tab[T_idx, Fn_idx + 1] - Cw_tab[T_idx, Fn_idx]
    )

    CwU = Cw_tab[T_idx + 1, Fn_idx] + Fn_frac * (
        Cw_tab[T_idx + 1, Fn_idx + 1] - Cw_tab[T_idx + 1, Fn_idx]
    )
